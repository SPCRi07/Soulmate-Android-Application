...
public class searchcardadapter extends RecyclerView.Adapter<searchcardadapter.cardviewholder> {
    ...
    private ArrayList<searchcarditems> mlistcarditems;
    private String Name[];
    ...
    public cardviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        user = new HashMap<String, String>();
            itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_search_recycleview, null, false);
    ...
    public searchcardadapter(ArrayList<searchcarditems> listcarditems){
    ...
    public void onBindViewHolder(@NonNull cardviewholder holder, int position) {
        ...
        searchcarditems currentitem = mlistcarditems.get(position);
    ...
    public  class cardviewholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public cardviewholder(View itemView) {
            ...
            textView1=(TextView) itemView.findViewById(R.id.searchname);
            c1=(CardView)itemView.findViewById(R.id.searchcard1);
            textView3=(TextView)itemView.findViewById(R.id.searchprofileidretreived);
           // imageButton=(ImageButton)itemView.findViewById(R.id.requestcancel);
            imageView1=(CircleImageView)itemView.findViewById(R.id.searchphoto);
