...
public class personaldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_city = (Spinner) findViewById(R.id.spinnercity);
        ...
        final ArrayAdapter ad1 = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_state);
        ...
        sp_state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_gujarat);
                }

                if (position == 1) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_andhrapradesh);
                }

                if (position == 2) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_arunachalpradesh);
                }

                if (position == 3) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_assam);
                }

                if (position == 4) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_bihar);
                }

                if (position == 5) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_chhattisgarh);
                }

                if (position == 6) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_delhi);
                }

                if (position == 7) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_goa);
                }


                if (position == 8) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_haryana);
                }


                if (position == 9) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_himachalpradesh);
                }


                if (position == 10) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_jammukashmir);
                }


                if (position == 11) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_jharkhand);
                }


                if (position == 12) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_karnataka);
                }


                if (position == 13) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_kerala);
                }


                if (position == 14) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_madhyapradesh);
                }


                if (position == 15) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_maharastra);
                }


                if (position == 16) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_meghalay);
                }


                if (position == 17) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_mizoram);
                }


                if (position == 18) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_nagaland);
                }


                if (position == 19) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_odisha);
                }


                if (position == 20) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_pondichery);
                }


                if (position == 21) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_panjab);
                }


                if (position == 22) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_rajasthan);
                }


                if (position == 23) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_sikkim);
                }


                if (position == 24) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_tripura);
                }


                if (position == 25) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_uttarpradesh);
                }


                if (position == 26) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_uttarakhand);
                }


                if (position == 27) {
                    arrayAdapter_city = new ArrayAdapter(personaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_westbengal);
                }
        ...
        nextpersonaldetails = (Button) findViewById(R.id.btnnextpersonaldetails);
        ...
        nextpersonaldetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rgb.getCheckedRadioButtonId() != -1 && date1.getText().length() != 0 && sp_city.getSelectedItem() != null && sp_state.getSelectedItem() != null) {
                    ...
                    uservalues.dob=dob;
                    Intent i = new Intent(personaldetails.this, careerdetails.class);
                    startActivity(i);
                } else {
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(personaldetails.this, new DatePickerDialog.OnDateSetListener() {
