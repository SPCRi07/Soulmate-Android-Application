...
public class profilevisitorcardadapter extends RecyclerView.Adapter<profilevisitorcardadapter.cardviewholder> {

    private ArrayList<profilevisitorcarditems> mlistcarditems;
    private String Name[];
    ...
    public cardviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        user = new HashMap<String, String>();
            itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_profileview_recycleview, null, false);
    ...
    public profilevisitorcardadapter(ArrayList<profilevisitorcarditems> listcarditems){
    ...
    public void onBindViewHolder(@NonNull cardviewholder holder, int position) {
        ...
        profilevisitorcarditems currentitem = mlistcarditems.get(position);
    ...
    public  class cardviewholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public cardviewholder(View itemView) {
            ...
            textView1=(TextView) itemView.findViewById(R.id.profileviewname);
            c1=(CardView)itemView.findViewById(R.id.profileviewcard1);
            textView3=(TextView)itemView.findViewById(R.id.profileviewprofileidretreived);
           // imageButton=(ImageButton)itemView.findViewById(R.id.requestcancel);
            imageView1=(CircleImageView)itemView.findViewById(R.id.profileviewphoto);
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    ...
                    try {
                        if(response.getString("res").equals("ok")) {
                            ...
                            Toast.makeText(itemView.getContext(),"request deleted successfully",Toast.LENGTH_SHORT).show();
