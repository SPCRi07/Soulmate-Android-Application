...
public class profileupload extends AppCompatActivity{
    ...
    String ServerUploadPath ="https://soulmatepa.000webhostapp.com/imageupload.php" ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profileupload);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(profileupload.this,verify_number.class);
                startActivity(i);
            }
        });
       ...
       SelectImageGallery.setOnClickListener(new View.OnClickListener() {
        ...
        UploadImageServer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GetImageNameEditText=sharedPreferences.getString("id",null);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                super.onPreExecute();
                progressDialog = ProgressDialog.show(profileupload.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(profileupload.this,"uploaded", Toast.LENGTH_LONG).show();
                    Intent i=new Intent(profileupload.this,verify_number.class);
                    startActivity(i);
