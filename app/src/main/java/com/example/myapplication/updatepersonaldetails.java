...
public class updatepersonaldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgb = findViewById(R.id.updaterbg);
        sessionManagement=new SessionManagement(getApplicationContext());
        HashMap<String, String> user = sessionManagement.getUserDetails();
        id=user.get(SessionManagement.KEY_ID);
        sp_city = (Spinner) findViewById(R.id.updatespinnercity);
        sp_state = (Spinner) findViewById(R.id.updatespinnerstate);
        d=(TextView)findViewById(R.id.updatedob);
        ...
        /*sp_state=(Spinner)findViewById(R.id.spinnerstate);
        ar_state=new ArrayList<>();
        ar_state.add("Andhra Pradesh");
        ar_state.add("Arunachal Pradesh");
        ar1.add("Assam");
        ar1.add("Bihar");
        ar1.add("Chhattisgarh");
        ar1.add("Daman & Diu");
        ar1.add("Delhi");
        ar1.add("Goa");
        ar1.add("Gujarat");
        ar1.add("Haryana");
        ar1.add("Himachal Pradesh");
        ar1.add("Jammu & Kashmir");
        ar1.add("Jharkhand");
        ar1.add("Karnataka");
        ar1.add("kerala");
        ar1.add("Madhya Pradesh");
        ar1.add("Maharastra");
        ar1.add("Manipur");
        ar1.add("Meghalay");
        ar1.add("Panjab");
        ...
        date1 = (TextView) findViewById(R.id.updatedate);
        ...
        sp_state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_gujarat);
                }

                if (position == 1) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_andhrapradesh);
                }

                if (position == 2) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_arunachalpradesh);
                }

                if (position == 3) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_assam);
                }

                if (position == 4) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_bihar);
                }

                if (position == 5) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_chhattisgarh);
                }

                if (position == 6) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_delhi);
                }

                if (position == 7) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_goa);
                }


                if (position == 8) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_haryana);
                }


                if (position == 9) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_himachalpradesh);
                }


                if (position == 10) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_jammukashmir);
                }


                if (position == 11) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_jharkhand);
                }


                if (position == 12) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_karnataka);
                }


                if (position == 13) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_kerala);
                }


                if (position == 14) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_madhyapradesh);
                }


                if (position == 15) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_maharastra);
                }


                if (position == 16) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_meghalay);
                }


                if (position == 17) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_mizoram);
                }


                if (position == 18) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_nagaland);
                }


                if (position == 19) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_odisha);
                }


                if (position == 20) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_pondichery);
                }


                if (position == 21) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_panjab);
                }


                if (position == 22) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_rajasthan);
                }


                if (position == 23) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_sikkim);
                }


                if (position == 24) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_tripura);
                }


                if (position == 25) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_uttarpradesh);
                }


                if (position == 26) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_uttarakhand);
                }


                if (position == 27) {
                    arrayAdapter_city = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_westbengal);
                }
        ...
        final ArrayAdapter ad1 = new ArrayAdapter(updatepersonaldetails.this, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, ar_state);
        sp_state.setAdapter(ad1);

        nextpersonaldetails = (Button) findViewById(R.id.updatepersonaldetails_page);

        nextpersonaldetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (rgb.getCheckedRadioButtonId() != -1 && date1.getText().length() != 0 && sp_city.getSelectedItem() != null && sp_state.getSelectedItem() != null) {
                    int selectedId = rgb.getCheckedRadioButtonId();
                    radioButton = (RadioButton) findViewById(selectedId);
                    uservalues.gender = radioButton.getText().toString();
                    uservalues.state = sp_state.getSelectedItem().toString();
                    uservalues.city = sp_city.getSelectedItem().toString();
                    uservalues.dob=dob;
                    match();
                } else {
                    Toast.makeText(getApplicationContext(), "Select Every Field", Toast.LENGTH_SHORT).show();
                }
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(updatepersonaldetails.this, new DatePickerDialog.OnDateSetListener() {

                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        date1.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                        dob=dob.replace("",dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                    }
                }, dyear, dmonth, dday);
                dpd.show();
            }
    ...
    private void match(){
        ...
        client.post(Constants.Update_personaldetails,rp,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                super.onSuccess(statusCode, headers, response);
                try {
                    if(response.getString("res").equals("ok")) {
                        Intent i = new Intent(updatepersonaldetails.this, editprofile.class);
                        startActivity(i);
